...
public class Filiere_supprimer extends javax.swing.JFrame {

    /**
     * Creates new form A_Menu
     */
        private DefaultTableModel model;
    public Filiere_supprimer() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Supprimer filières");
    ...
    if (selectedRowIndex == -1) {
        JOptionPane.showMessageDialog(null, "Veuillez sélectionner une filière à supprimer.", "Aucune sélection", JOptionPane.WARNING_MESSAGE);
        return;
    }
    
    int filiereId = (int) jTable1.getValueAt(selectedRowIndex, 0);
    
    int option = JOptionPane.showConfirmDialog(null, "Voulez-vous vraiment supprimer cette filière ?", "Confirmation", JOptionPane.YES_NO_OPTION);
...
private void deleteFiliere(int filiereId) {
    ...
    try (PreparedStatement ps = ConnectionDB.getConnection().prepareStatement(query)) {
        ...
        if (rowsAffected > 0) {
            JOptionPane.showMessageDialog(null, "Filière supprimée avec succès.", "Suppression réussie", JOptionPane.INFORMATION_MESSAGE);
            loadData(); // Refresh the table after deletion
        } else {
            JOptionPane.showMessageDialog(null, "Impossible de supprimer la filière.", "Erreur", JOptionPane.ERROR_MESSAGE);
        }
    } catch (SQLException e) {
        JOptionPane.showMessageDialog(null, "Une erreur s'est produite lors de la suppression de la filière: " + e.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Filiere_supprimer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Filiere_supprimer().setVisible(true);
            }
        });
    }
