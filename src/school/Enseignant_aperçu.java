 ...
 */
public class Enseignant_aperçu extends javax.swing.JFrame {

    /**
     * Creates new form A_Menu
     */
    private DefaultTableModel model;
    public Enseignant_aperçu() {
        initComponents();
        setTitle("Aperçu enseignants");
...
private void fillComboBox() {
  String query = "SELECT DISTINCT CONCAT(nom, ' ', prenom) AS nom_prenom\n" +
                 "FROM enseignant;";
  model.setRowCount(0); // Clear existing data from the table
  try (Connection conn = ConnectionDB.getConnection();
       PreparedStatement ps = conn.prepareStatement(query)) { // Set the parameter value (no parameter here)
    try (ResultSet rs = ps.executeQuery()) {
      // Add an empty string as the first item
      jComboBox1.addItem("");

      while (rs.next()) {
        String nom_prenom = rs.getString("nom_prenom"); // Use the aliased column name
        jComboBox1.addItem(nom_prenom);
      }
    }
  } catch (SQLException e) {
    JOptionPane.showMessageDialog(null, "An error occurred while loading data: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Afficher enseignants");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("Nom enseignant");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // Get the selected item from the combo box (assuming it contains nom_prenom)
  ...
  if (selectedItem.isEmpty()) {
    ...
    query = "SELECT * FROM enseignant WHERE CONCAT(nom, ' ', prenom) = ?";
  }
  ...
  try (Connection conn = ConnectionDB.getConnection();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Enseignant_aperçu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                        Enseignant_aperçu gest = new Enseignant_aperçu();
