...
public class Enseignant_ajouter extends javax.swing.JFrame {

    /**
     * Creates new form A_Menu
     */
    public Enseignant_ajouter() {
        initComponents();
        setTitle("Ajouter enseignants");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ajouter enseignant");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtCoordonnees, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(68, 68, 68)
  ...
  if (nom.isEmpty() || prenom.isEmpty() || specialite.isEmpty() || coordonnees.isEmpty()) {
    JOptionPane.showMessageDialog(null, "Please fill all fields!");
    return; // Abort if any field is empty
  }

  // Check if enseignant already exists (optional)
  String checkQuery = "SELECT * FROM enseignant WHERE CONCAT(nom, ' ', prenom) = ?";
  boolean enseignantExists = false;
  try (Connection conn = ConnectionDB.getConnection();
       PreparedStatement ps = conn.prepareStatement(checkQuery)) {
    ps.setString(1, nom + " " + prenom); // Combine nom and prenom
    try (ResultSet rs = ps.executeQuery()) {
      enseignantExists = rs.next(); // Check if any results are found
    }
  } catch (SQLException e) {
    JOptionPane.showMessageDialog(null, "An error occurred while checking existence: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
    return; // Abort on error checking existence
  }

  if (enseignantExists) {
    JOptionPane.showMessageDialog(null, "Enseignant déjà existant!");
    return; // Abort if enseignant exists
  }

  // Prepare the insert query (proceed if enseignant doesn't exist)
  String query = "INSERT INTO enseignant (nom, prenom, specialite, coordonnees) VALUES (?, ?, ?, ?)";
  ...
  try (Connection conn = ConnectionDB.getConnection();
    ...
    if (rowsAffected > 0) {
      ...
      JOptionPane.showMessageDialog(null, "Échec de l'ajout d'enseignant!");
    }
  } catch (SQLException e) {
    JOptionPane.showMessageDialog(null, "An error occurred while adding: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
  }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Enseignant_ajouter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                        Enseignant_ajouter gest = new Enseignant_ajouter();
