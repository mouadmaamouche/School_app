...
public class Enseignant_supprimer extends javax.swing.JFrame {

    /**
     * Creates new form A_Menu
     */
            private DefaultTableModel model;
    public Enseignant_supprimer() {
        initComponents();
        setTitle("Gestion enseignants");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Supprimer enseignants");
  ...
  int confirmation = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this enseignant?", "Delete Confirmation", JOptionPane.YES_NO_OPTION);
  if (confirmation != JOptionPane.YES_OPTION) {
    return; // Abort if user cancels deletion
  }
  ...
  try (Connection conn = ConnectionDB.getConnection();
    ...
    if (rowsAffected > 0) {
      ...
      JOptionPane.showMessageDialog(null, "Échec de la suppression de l'enseignant!");
    }
  } catch (SQLException e) {
    JOptionPane.showMessageDialog(null, "An error occurred while deleting: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
  }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Enseignant_supprimer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                        Enseignant_supprimer gest = new Enseignant_supprimer();
