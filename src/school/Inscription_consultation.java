...
public class Inscription_consultation extends javax.swing.JFrame {

    /**
     * Creates new form A_Menu
     */
    private DefaultTableModel model;
    public Inscription_consultation() {
        initComponents();
        setTitle("Menu");
        model = new DefaultTableModel(new Object[]{"ID", "Prenom", "Nom", "Date inscription"}, 0);
        jTable1.setModel(model);
        fillComboBox();
    }
    
    private void fillComboBox() {
        String query = "SELECT DISTINCT nom FROM filiere";
        model.setRowCount(0); // Clear existing data from the table
        jComboBox1.removeAllItems(); // Clear any existing items in the combo box
        jComboBox1.addItem(""); // Add an empty item as the first row
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Consultation des étudiants inscrits à une filière");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Prenom", "Nom", "Date inscription"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jButton7.setBackground(new java.awt.Color(251, 133, 0));
    ...
    if (selectedFiliere == null || selectedFiliere.isEmpty()) {
        JOptionPane.showMessageDialog(null, "Please select a filiere.", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }

    String query = "SELECT st.student_id, st.first_name, st.last_name, ins.date_inscription " +
                   "FROM students AS st " +
    ...
    try (Connection conn = ConnectionDB.getConnection();
        ...
        try (ResultSet rs = ps.executeQuery()) {
            while (rs.next()) {
                ...
                model.addRow(new Object[]{studentId, firstName, lastName, dateInscription});
            }
        }
    } catch (SQLException e) {
        JOptionPane.showMessageDialog(null, "An error occurred while loading data: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inscription_consultation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Inscription_consultation().setVisible(true);
            }
        });
    }
