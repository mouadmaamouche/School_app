...
public class Filiere_aperçu extends javax.swing.JFrame {

    /**
     * Creates new form A_Menu
     */
     private DefaultTableModel model;
    public Filiere_aperçu() {
        initComponents();
        setTitle("Menu");
        model = new DefaultTableModel(new Object[]{"id", "Nom", "Code", "enseignant_responsable", "Horaires"}, 0);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Liste des modules par filière");
...
// Define the SQL query to retrieve data based on the selected value
String query = "SELECT * FROM module WHERE id_filiere IN (SELECT id FROM filiere WHERE nom = ?)";

try (Connection conn = ConnectionDB.getConnection();
     PreparedStatement ps = conn.prepareStatement(query)) {

    // Set the parameter value for the nom column
    ...
    try (ResultSet rs = ps.executeQuery()) {
        while (rs.next()) {
            ...
            String enseignant_responsable = rs.getString("enseignant_responsable");
            String horaires = rs.getString("horaires");
            // Add each row to the table model
            model.addRow(new Object[]{id, nom, enseignant_responsable, horaires});
        }
    }
...
private void fillComboBox() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Filiere_aperçu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Filiere_aperçu().setVisible(true);
            }
        });
    }
